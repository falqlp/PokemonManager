...
// allPokemonBase.forEach((pokemon) => {
//   let types = getFrenchType(pokemon.type);
...
//       spAtk: pokemon.base["Sp. Attack"],
//       spDef: pokemon.base["Sp. Defense"],
//       spe: pokemon.base.Speed,
//     },
//   });
//   newPokemon.save().then("ok");
// });

function getFrenchType(types) {
  let newTypes = [];
  types.forEach((type) => {
    let newType;
    switch (type) {
